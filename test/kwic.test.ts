...
const line = (left: string[], node: string, right: string[], extra: any = {}): KwicLine => ({
  ...
  legacy_text: null, text_layer: null, text_layer_status: null,
});
...
test("KWIC lines carry additive text-layer provenance", async () => {
  ...
  const layer = [{ id: node.sentence_id, legacy_text: "opopmau keutum", text_layer: "modern-orthography-latn@1", text_layer_status: "provisional" }];
